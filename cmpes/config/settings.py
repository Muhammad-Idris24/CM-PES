...
CMPES_ADMIN_EMAIL = env("CMPES_ADMIN_EMAIL", default="")
CMPES_ADMIN_PASSWORD = env("CMPES_ADMIN_PASSWORD", default="")
CMPES_ADMIN_FULL_NAME = env("CMPES_ADMIN_FULL_NAME", default="CMPES Administrator")
CMPES_ADMIN_RESET_PASSWORD = env.bool("CMPES_ADMIN_RESET_PASSWORD", default=False)
